    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <button onClick={() => setActiveTab('laporWarga')} className="bg-red-50 p-3 rounded-2xl shadow-sm border border-red-200 flex flex-col items-center justify-center gap-2 hover:bg-red-100 transition col-span-4 relative overflow-hidden">
